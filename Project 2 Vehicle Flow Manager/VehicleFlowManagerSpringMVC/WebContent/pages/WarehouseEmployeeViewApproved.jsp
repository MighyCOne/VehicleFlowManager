...
<body>
	...
	<center>
		<form:form method="POST"
			action="${pageContext.request.contextPath}/pwe/SentReview">
			...
			<table border="1" class="table-striped">
				...
				<%
					//This page should display a list of vehicles (id,where they came from,etc.) whose request where transit and their destination location was to my location
						for (Request req : (List<Request>) session.getAttribute("approved_list")) {
				...
				<tr>
					...
					<td><input type="checkbox" name="sentReqId"
			...
			<input type="submit" class="btn btn-primary" value="Mark As Sent" />
